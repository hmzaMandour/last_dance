                        ...
                        <div class="p-6">
                            ...
                            <form action="" method="POST">
                                ...
                                <button id="tranzabadan"
                                    class="w-full px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors">
                                    Take it now
                                </button>
                            </form>
                        </div>
                    ...
                    document.addEventListener('DOMContentLoaded', async function() {
                        ...
                        var calendar = new FullCalendar.Calendar(myCalendar, {
                            ...
                            eventClick: (info) => {
                                ...
                                document.getElementById('description').textContent = "About the course: " + a
                                    .description;
